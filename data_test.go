...
var testData = testTable{
	...
	{[]byte{0, 0, 0xAA}, []byte{0x60, 0xAA, 0xA1}},
	{[]byte{0, 0, 0xFF}, []byte{0x60, 0xFF, 0xA1}},
	{[]byte{0, 0, 0, 0xAA}, []byte{0x50, 0xAA, 0xA1}},
	{[]byte{0, 0, 0, 0xFF}, []byte{0x50, 0xFF, 0xA1}},
	...
	{[]byte{0xFF, 0xFF, 0xFF, 0xFF, 0xAA}, []byte{0xF0, 0xAA, 0xA1}},
	...
	{[]byte{0, 0, 0, 0, 0, 0xAA, 0xFF, 0xFF, 0xAA}, []byte{0x20, 0x20, 0xAA, 0xC1, 0xAA, 0xA1}},
	{[]byte{0, 0, 0, 0, 0}, []byte{0x20, 0x20}},
	{[]byte{0, 0, 0, 0, 0, 0xFF}, []byte{0x20, 0x20, 0xFF, 0xA1}},
	{[]byte{0, 0, 0, 0, 0, 0xAA}, []byte{0x20, 0x20, 0xAA, 0xA1}},
	{[]byte{0, 0, 0, 0, 0, 0, 0xFF}, []byte{0x20, 0x60, 0xFF, 0xA1}},
	...
	{[]byte{0xAA, 0xAA, 0xAA, 0xAA, 0xAA}, []byte{0xAA, 0x02}},
	...
	{[]byte{0, 2, 2, 2, 0, 1, 0, 255, 255, 255, 1, 2, 1, 0, 255, 1, 2, 0, 0, 1, 2, 1, 255, 1, 2, 2, 2, 255, 1, 2, 0, 255, 2, 2, 0, 255},
		[]byte{0x20, 0x2, 0x81, 0x20, 0x1, 0x21, 0xe0, 0x1, 0x2, 0x1, 0x23, 0xff, 0x1, 0x2, 0x63, 0x1, 0x2, 0x1, 0xff, 0x1, 0x2, 0x86, 0xff, 0x1, 0x2, 0x23, 0xff, 0x2, 0x2, 0x23, 0xff, 0xa1},
	},
	{[]byte{0x02, 0x01, 0xff, 0x01, 0x01, 0x02, 0x02, 0x01, 0xff, 0x01, 0x01, 0x01, 0x01, 0x01},
		[]byte{0x2, 0x1, 0xff, 0x1, 0x1, 0x2, 0x2, 0x1, 0xff, 0x1, 0xb},
	},
	{[]byte{0x01, 0x02, 0x00, 0x00, 0xff, 0x02, 0xff, 0x01, 0x00, 0x00, 0x00, 0x02, 0x01, 0xff, 0x01, 0x01, 0x02, 0x02, 0x01, 0xff, 0x01, 0x01, 0x01, 0x01, 0x01},
		[]byte{0x1, 0x2, 0x62, 0xff, 0x2, 0xff, 0x1, 0x54, 0x2, 0x1, 0xff, 0x1, 0x1, 0x2, 0x2, 0x1, 0xff, 0x1, 0xb},
	},

	{[]byte{0xFF}, []byte{0xFF, 0xA1}},                                                 // could be only FF
	{[]byte{0xFF, 0x02, 0x02, 0x00, 0xFF}, []byte{0xFF, 0x02, 0x02, 0x23, 0xFF, 0xA1}}, // last A1 not needed

	// err {[]byte{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00}, []byte{0xFF, 0xFF, 0x20}},
	// err {[]byte{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAA}, []byte{0xFF, 0xFF, 0xAA, 0xA3}},
	// err {[]byte{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}, []byte{0xFF, 0xC1}},
	// err{[]byte{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAA, 0xFF, 0xFF}, []byte{0xff, 0xff, 0xaa, 0xc3}},
}
